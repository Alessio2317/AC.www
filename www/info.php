...
<head>
    ...
    <title>Informazioni PHP - ALESSIO CAINARCA</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per ALESSIO CAINARCA</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> ALESSIO CAINARCA</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> cainarca.alessio</p>
